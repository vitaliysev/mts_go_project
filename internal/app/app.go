...
func (a *App) initGRPCServer(ctx context.Context) error {
	...
	desc.RegisterBookingV1Server(a.grpcServer, a.serviceProvider.BookingImpl(ctx))
...
func (a *App) initHTTPServer(ctx context.Context) error {
	...
	err := desc.RegisterBookingV1HandlerFromEndpoint(ctx, mux, a.serviceProvider.GRPCConfig().Address(), opts)
	if err != nil {
		return err
	}
